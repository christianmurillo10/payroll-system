...
module.exports = (sequelize, DataTypes) => {
  const PayrollPhicContributions = sequelize.define('PayrollHdmfContributions', {
    'id': {
    ...
    'contribution_type': {
      ...
      allowNull: false,
      comment: '1=Bi-Monthly Contribution 2=Bi-Monthly Salary Loan 3=Bi-Monthly Housing',
      defaultValue: '1'
    },
    'created_at': {
      type: 'TIMESTAMP',
    ...
    tableName: "payroll_hdmf_contributions",
    timestamps: false
  });
