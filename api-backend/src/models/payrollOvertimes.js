...
module.exports = (sequelize, DataTypes) => {
  const PayrollOvertimes = sequelize.define('PayrollOvertimes', {
    'id': {
    ...
    tableName: "payroll_overtimes",
    timestamps: false
  });

  PayrollOvertimes.associate = (models) => {
    PayrollOvertimes.belongsTo(models.Payrolls, {
      foreignKey: 'payroll_id',
      as: 'payrolls'
    });
    PayrollOvertimes.belongsTo(models.Employees, {
      foreignKey: 'employee_id',
      as: 'employees'
    });
    PayrollOvertimes.belongsTo(models.Users, {
      foreignKey: 'user_id',
      as: 'users'
    });
  };
