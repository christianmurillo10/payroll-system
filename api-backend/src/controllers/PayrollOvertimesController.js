...
module.exports = {
   ...
   * @routes POST /payrollOvertime/create
   */
  ...
  compute: (req, res) => {
    ...
    jsonfile.readFile(file, (err, data) => {
      ...
      let regularDay = computationTools(basic, data.fixedWorkingDays, data.fixedWorkingHours, params.regular_day, data.overtime.regularDay);
      let specialDay = computationTools(basic, data.fixedWorkingDays, data.fixedWorkingHours, params.special_day, data.overtime.specialDay);
      let specialDayFord = computationTools(basic, data.fixedWorkingDays, data.fixedWorkingHours, params.special_day_ford, data.overtime.specialDayFord);
      let holiday = computationTools(basic, data.fixedWorkingDays, data.fixedWorkingHours, params.holiday, data.overtime.holiday);
      let holidayFord = computationTools(basic, data.fixedWorkingDays, data.fixedWorkingHours, params.holiday_ford, data.overtime.holidayFord);
...
const computationTools = (basic, fixedWorkingDays, fixedWorkingHours, numberOfHours, percentage) => {
